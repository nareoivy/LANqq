...
public class SendCreateGroupHander {
	...
	public SendCreateGroupHander(String ip,int port,DiscussGroup discussGroup,Hander hander){
		this.ip = ip;
		this.port = port;
	...
	private boolean sendCreateGroupHander()
	{
		if (cs == null)
			return false;
